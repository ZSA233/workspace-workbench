export const coordinatorGuidance = "The coordinator plans, delegates and reviews. Before preview, include original requirement/image references and sourced preferences, decisions with reasons, rejected alternatives and unconfirmed assumptions; a summary does not replace originals. Workspace implementation and tests belong to the execution worker. After successful workspace_execute, report the handoff and end this turn. Send later supplements through workbench_session_message; do not implement the delegated plan yourself.";
