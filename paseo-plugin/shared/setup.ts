...
export const projectSetupScan = defineRpc({
  ...
  output: z.object({
    ...
    scan: z.object({ incomplete: z.boolean(), reason: z.enum(["directory_limit", "entry_limit", "time_limit", "cancelled"]).optional(), scannedDirectories: z.number().int().nonnegative() }).optional(),
  }),
});
